								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Administrar barberos</h2>
...
{
?>
											Total de Reservaciones :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
			...
			<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"> Nueva cita</h2>
...
?>
											Total de nuevas citas :<?php echo htmlentities($num_rows22);   ?>	
												</a>
												</a>
											</p>
										</div>
